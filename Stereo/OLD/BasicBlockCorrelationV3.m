...
% left_rectf_crop1=edge(left_rectf_crop,'Sobel',1);
% right_rectf_crop1=edge(right_rectf_crop,'Sobel',1);

left_rectf_crop1=edge(left_rectf_crop,'Canny',0.1);
right_rectf_crop1=edge(right_rectf_crop,'Canny',0.1);
...
for y=wd2+1:1:size(left_res,1)-wd2 %Left image row pix
    ...
    for x=wd2+dispmax+1:1:size(left_res,2)-wd2  %Left image col pix
        ...
        for disp=dispmin:1:dispmax
            ...
            [temp,depth(y-wd2,x-wd2-dispmax)]=min(SAD(dispmin:dispmax));
